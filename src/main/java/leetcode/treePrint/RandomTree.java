...
public class RandomTree {
    ...
    public static void main(String[] args) {
         ...
         */
        TreePrinter<TreeNode> printer = new TreePrinter<>(n -> nameForNumber(n.val), n -> n.getLeft(), n -> n.getRight());
        // set minimum horizontal spacing between leetcode.node labels with setHspace
        printer.setHspace(1);
        // use square branches
